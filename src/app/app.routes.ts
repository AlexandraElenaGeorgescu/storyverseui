...
export const routes: Routes = [
  ...
  { path: 'event-create', component: StoryCreateComponent, canActivate: [AuthGuardService] },
  { path: 'event-browse/:pageSize/:pageId', component: StoryBrowseComponent },
  { path: 'event-details/:id', component: StoryDetailsComponent },
  { path: 'event-stats/:id', component: StoryStatsComponent, canActivate: [AuthGuardService] },
